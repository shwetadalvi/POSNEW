...
public class InventoryDetailsAdapter extends RecyclerView.Adapter<InventoryDetailsAdapter.ViewHolder> {

    List<InventoryTransaction> mTransactionList = new ArrayList<>() ;
    private ClickListeners.ItemClick<InventoryTransaction> mTransactionItemClick;

    public InventoryDetailsAdapter(List<InventoryTransaction> TransactionList, ClickListeners.ItemClick<InventoryTransaction> TransactionItemClick) {
