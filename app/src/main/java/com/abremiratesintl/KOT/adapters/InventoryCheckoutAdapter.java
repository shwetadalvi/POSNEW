...
import com.abremiratesintl.KOT.fragments.InventoryCheckoutFragment;
...
public class InventoryCheckoutAdapter extends RecyclerView.Adapter<InventoryCheckoutAdapter.ViewHolder> {
    ...
    private InventoryCheckoutFragment mCheckoutFragment;
    private MarkItemListener markItemListener;
    Context mContext;

    public InventoryCheckoutAdapter(List<Items> itemsList, CheckoutCountClickListeners checkoutCountClickListeners, InventoryCheckoutFragment checkoutFragment) {
