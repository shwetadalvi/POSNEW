...
public class CategorySpinnerAdapter<T> extends ArrayAdapter<T> {
    ...
    public CategorySpinnerAdapter(Context context, int textViewResourceId, List<T> spinnerItemList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (spinnerItemList.get(position) instanceof Category) {
            mViewHolder.item.setText(((Category) spinnerItemList.get(position)).getCategoryName());
        }
        return convertView;
    }
